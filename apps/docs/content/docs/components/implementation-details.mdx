...
description: Deep dive guide on importing components, full component-to-file mapping, sub-component breakdown, and component prop specifications for @celestia-project/ui.
icon: code
---

This document provides complete technical implementation details for `@celestia-project/ui`, including import conventions, component module mappings, sub-component exports, underlying primitives, and prop APIs.
